# IS 310 Group Planning Document  
**Group Theme:** Gaming  
**Course:** IS 310 Culture as Data
**Semester:** Spring 2026  

---

## Group Theme: Gaming as Culture and Data
...
#### In Scope
- Video games (PC, console, and mobile)
- Player behavior and engagement
- Gaming communities and fandoms
- Game genres, mechanics, and design patterns
- Esports and competitive gaming
- Representation, identity, and inclusivity in games
- Reviews, ratings, playtime, performance, and social interaction data
- Streaming and content creation around games

#### Out of Scope
- Gambling and casino games
- Hardware benchmarking and system performance
- Purely technical game engine or graphics analysis
- Non-digital tabletop games (unless digitally mediated)
- Game development tutorials or code-focused datasets
...
### Charles Cantrell
- **Proposed Dataset:** RPG changes and trends analysis
- **Dataset Source:** https://www.igdb.com/

- **Description:**  
  Contains information about Video game releases such as title, platform(s), release year, genre, publisher, developer, scores, perspective(s), gamemodes, & themes. The database has games from over the years and tagged themes & genres. The scores in the dataset are user reported reception scores.
...
### Anshuman Satpute
- **Proposed Dataset:** Valorant Leaderboard Statistics (Kaggle)
- **Dataset Source:** https://www.kaggle.com/datasets/aliibrahim10/valorant-stats
- **File Used:** val_stats.csv

- **Description:**  
This dataset contains leaderboard statistics for over 80,000 Valorant players collected from a public stats tracker (e.g., tracker.gg), focusing on ranked/competitive play. Each row represents a player with multiple performance metrics such as ranking position, rating, and in‑game stats that reflect their performance on the leaderboard. The val_stats.csv file provides a structured table that can be used to analyze relationships between different stats and a player’s standing on the leaderboard

- **Relation to Group Theme:**  
The dataset directly fits a theme of competitive gaming and esports performance, since it captures how players perform in ranked Valorant, a major tactical shooter. Leaderboards are a core cultural feature of competitive games, so these statistics connect to questions about skill, status, and improvement in online gaming communities. Because the data is large‑scale and standardized, it lets the group explore performance patterns within one specific game while still relating to broader ideas about player behavior and competitive culture.

- **Why This Topic:**  
As a competitive valorant player i feel like it is a popular, data‑rich esport, and this dataset offers enough observations and features to support meaningful quantitative analysis over the semester. It aligns with personal interest in Valorant while also enabling generalizable questions about what distinguishes top players from the rest of the ladder.
...
### Communication
- Primary communication via Discord or group messaging platform
- In-class work sessions used for planning and check-ins
- Weekly asynchronous updates on progress

### GitHub Organization Strategy
- One shared group repository
- Each team member maintains their own folder for datasets, analysis, and documentation
- Shared files (README, planning documents) stored at the root or in a `planning/` folder
- Use GitHub Issues to track tasks, questions, and milestones
- Pull requests used for major updates to shared files

### Version Control Practices
- Main branch used for stable content
- Clear commit messages describing changes
- Avoid direct edits to others’ folders without coordination

---

## Notes and Next Steps
- Dataset ideas are exploratory and may change as feasibility and scope become clearer
- Group theme may be refined as individual projects develop
